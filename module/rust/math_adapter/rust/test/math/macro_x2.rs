...
pub mod internal
{
  ...
  macro_rules! macro_test_x2_with_records
  {
    ...
    ( $Va : ident $( :: $Vb : ident )*, $_0 : ident, $_1 : ident ; $Type : ident $(, $( $tail : ident ),* )? ) =>
    {
      ...
      $crate::macro_test_x2_with_records!( $Va $( :: $Vb )* , $_0, $_1 ; $( $( $tail ),* )? );
    };
  ...
  macro_rules! macro_test_x2_as_specific
  {
    ...
    ( $Va : ident $( :: $Vb : ident )*, $Name : ident ; $Type : ident $(, $( $tail : ident ),* )? ) =>
    {
      ...
      $crate::macro_x2::macro_test_x2_as_specific!( $Va $( :: $Vb )*, $Name ; $( $( $tail ),* )? );
    }
  ...
  macro_rules! macro_test_x2_as_foreign
  {
    ...
    ( $Va : ident $( :: $Vb : ident )* ; $Type : ident $(, $( $tail : ident ),* )? ) =>
    {
      ...
      $crate::macro_x2::macro_test_x2_as_foreign!( $Va $( :: $Vb )* ; $( $( $tail ),* )? );
    }
  }
  ...
  macro_rules! macro_test_x2_operation_deref
  {
    ...
    ( $Va : ident $( :: $Vb : ident )* ; $Type : ident $(, $( $tail : ident ),* )? ) =>
    {
      ...
      $crate::macro_x2::macro_test_x2_operation_deref!( $Va $( :: $Vb )* ; $( $( $tail ),* )? );
    }
  }
  ...
  macro_rules! macro_test_x2_template
  {
    ...
    ( $Va : ident $( :: $Vb : ident )* ; $Type : ident $(, $( $tail : ident ),* )? ) =>
    {
      ...
      $crate::macro_x2::macro_test_x2_template!( $Va $( :: $Vb )* ; $( $( $tail ),* )? );
    }
  }

  // xxx : remove $Va $( :: $Vb )*?

  pub( crate ) use macro_test_x2_with_records;
  pub( crate ) use macro_test_x2_as_specific;
  pub( crate ) use macro_test_x2_as_foreign;
  pub( crate ) use macro_test_x2_operation_deref;
  pub( crate ) use macro_test_x2_template;
